...
speed = 60
angles = [-145.1318065, -90.29931722, -157.58785753, 171.50749586, 0, 0]
a2 = [145.1318065, 90.29931722, 157.58785753, -171.50749586, 0, 0]
for i in range(10):
    # run on mode(7)
    # the running command will be interrupted, and run the new command
    arm.set_servo_angle_j(angles=angles, speed=speed)
    time.sleep(1)
    # the running command will be interrupted, and run the new command
    arm.set_servo_angle_j(angles=a2, speed=speed)
    time.sleep(1)
